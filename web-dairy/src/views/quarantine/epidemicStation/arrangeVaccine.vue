...
<template>
	<div class="arrangeVaccine">
		...
		<Row>
			...
			<Col span="4">
				<Select v-model="filtItem.area" clearable placeholder="请选择区域">
			...
			<Col offset="1" span="2"><Button type="primary" @click="$jump('/arrangeVaccine/addNewSendVaccine')">新增发放记录</Button></Col>
		</Row>
		<br>
		...
		<el-table :data="manageAreaListData.data" style="width: 100%">
			...
			<el-table-column label="领取防疫人员" prop="receivePerson" width="140"></el-table-column>
...
export default {
	...
	data() {
		return {
			...
			manageAreaListData:{
				data:[
					{sendTime:'2020-01-05 00:00:00',receivePerson:'张山峰',belongArea:'乌兰察布路街道',reciveStatus:'已领取',reciveTime:'2020-01-14 00:00:00',vaccineDetail:''},
					{sendTime:'2020-01-05 00:00:00',receivePerson:'张山峰',belongArea:'人民路街道',reciveStatus:'未领取',reciveTime:'-',vaccineDetail:''}
				]
			},
