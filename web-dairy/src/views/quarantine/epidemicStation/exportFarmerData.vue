      ...
      <Col offset="1" span="3">
       <Select v-model="filtItem.count" clearable placeholder="请选择养殖规模" @on-change="initData">
		...
		<el-table :data="farmerListData.list" style="width: 100%">
			<el-table-column label="养殖户" prop="fullName" width="100" align="center"></el-table-column>
...
export default {
	...
	methods: {
		...
		exprt(){
   			axios({
				method: 'get',
				url: api.apiNomal+"/farmer/exportFarmerList",
				// headers里面设置token
				headers: {
				...
				params: {
					areaId: this.filtItem.areaId,
					kindId:this.filtItem.kindId,
					count:this.filtItem.count
				},
				dataType:'json',
